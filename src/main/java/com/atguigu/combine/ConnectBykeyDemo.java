...
public class ConnectBykeyDemo {
    public static void main(String[] args) throws Exception {
        ...
        ConnectedStreams<Tuple2<Integer, String>, Tuple3<Integer, String, Integer>> connectBykey = connect.keyBy(r -> r.f0, r -> r.f0);
         ...
         */
        SingleOutputStreamOperator<String> process = connectBykey.process(new CoProcessFunction<Tuple2<Integer, String>, Tuple3<Integer, String, Integer>, String>() {
            // 每条流定义 一个hashmap, 用来存数据
