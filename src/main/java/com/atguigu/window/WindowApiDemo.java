...
public class WindowApiDemo {
    public static void main(String[] args) throws Exception {
        ...
        // TODO 1. 指定  窗口分配器： 指定用哪一种窗口 ---   时间 or 计数？ 滚动、 滑动、 会话？
...
//        sensorDS.windowAll()
        ...
        // 基于时间的
//        sensorKS.window(TumblingProcessingTimeWindows.of(Time.seconds(10))) // 滚动窗口， 窗口长度为10s
//        sensorKS.window(SlidingProcessingTimeWindows.of(Time.seconds(10), Time.seconds(2)))  // 滑动窗口， 窗口长度为10s,  滑动步2s
